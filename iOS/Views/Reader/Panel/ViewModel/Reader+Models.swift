        ...
        @Published var data = Loadable<ChapterData>.idle {
            didSet {
                ...
                if !chapterData.archivePaths.isEmpty {
                    ...
                    pages = arr.map {
                        .init(page: Page(index: $0, chapterId: chapterId, contentId: chapter.contentId, sourceId: chapter.sourceId, archivePath: $1, archiveFile: chapterData.archiveFile))
                    }
                }
                // Downloaded
...
extension ReaderView.Page {
    ...
    private func loadImageFromArchive(_ file: URL, _ path: String, _ key: String) async throws -> ImageRequest {
